  ...
  return (
    <div className="mb-12 border border-black shadow-[8px_8px_0px_rgba(0,0,0,1)] bg-white animate-pulse-once relative">
        ...
        <div className="bg-black text-white px-6 py-4 flex justify-between items-center">
            <h2 className="font-display font-bold text-xl uppercase tracking-wider">Staff Control Panel</h2>
        ...
        <div className="p-8 border-b border-gray-100">
            <h3 className="text-[10px] font-bold text-black uppercase tracking-widest mb-6 border-l-2 border-penrice-gold pl-3">Create New Fixture</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
                <div>
                    <label className="block text-[10px] font-bold text-gray-400 uppercase mb-2">Sport</label>
                    <select 
                        className="w-full border-b-2 border-gray-200 py-2 text-sm font-bold outline-none bg-transparent"
                        value={sport}
        ...
        <div className="p-8 bg-gray-50 flex flex-col gap-8">
            {matches.map(match => (
                <div key={match.id} className="bg-white border border-gray-200 p-6 relative">
                    <div className="flex justify-between items-start mb-6 border-b border-gray-100 pb-4">
                        <div>
                            <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Editing</span>
                            <h4 className="font-display font-bold text-xl text-black uppercase">{match.teamName} / {match.opponent}</h4>
                        </div>
